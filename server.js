...
app.get('/recetas.html', function(req, res) {
    res.sendFile(path.join(__dirname, 'recetas.html'));
});
// Ruta para la página de premio
app.get('/ingredientes.html', function(req, res) {
    res.sendFile(path.join(__dirname, 'ingredientes.html'));
});
// Ruta para la página de premio
app.get('/lugares.html', function(req, res) {
